import{k as u,r as h,l as p,m as f,x as g}from"./index-d3e05a27.js";import{n as d,c as m}from"./index-cc40385c.js";import{o as b}from"./if-defined-a5dd1e7b.js";const y=u`
  :host {
    display: inline-flex;
...
`;var a=globalThis&&globalThis.__decorate||function(o,e,c,n){var i=arguments.length,r=i<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,c):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(o,e,c,n);else for(var l=o.length-1;l>=0;l--)(s=o[l])&&(r=(i<3?s(r):i>3?s(e,c,r):s(e,c))||r);return i>3&&r&&Object.defineProperty(e,c,r),r};let t=class extends f{constructor(){super(...arguments),this.icon="copy",this.size="md",this.padding="1",this.color="default"}render(){return this.dataset.padding=this.padding,this.dataset.color=this.color,g`
      <wui-icon size=${b(this.size)} name=${this.icon} color="inherit"></wui-icon>
    `}};t.styles=[h,p,y];a([d()],t.prototype,"icon",void 0);a([d()],t.prototype,"size",void 0);a([d()],t.prototype,"padding",void 0);a([d()],t.prototype,"color",void 0);t=a([m("wui-icon-box")],t);
